<template>
	<div id="Person">
		<div id="personTop" >
          	    <a><img src="@/assets/personImg/left.png" @click="back()"></a>
		...
		<div id="personContent">
			...
			<div id="data">
				...
				<div id="letter">
					<router-link to="">
						<img src="@/assets/personImg/aaa.png"/>
						<span>私信</span>
					</router-link>	
				</div>
				<div id="focusOn">
					<router-link to="">
						<img src="@/assets/personImg/gou.png"/>
						<span>已关注</span>
					</router-link>	
				</div>
			</div>
...
<script>
import Time from "../../personal/main/time.vue";
